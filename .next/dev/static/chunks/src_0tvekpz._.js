...
"[project]/src/components/auth/AuthInitializer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AuthInitializer = ()=>{
    _s();
    const { setUser, setProfile, setInitialized, setLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthInitializer.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then({
                "AuthInitializer.useEffect": ({ data: { session } })=>{
                    if (session) {
                        setUser(session.user);
                        // Fetch profile
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("*").eq("id", session.user.id).single().then({
                            "AuthInitializer.useEffect": ({ data, error })=>{
                                if (!error && data) {
                                    setProfile(data);
                                }
                                setInitialized(true);
            ...
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthInitializer.useEffect": async (event, session)=>{
                    if (session) {
                        setUser(session.user);
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("*").eq("id", session.user.id).single();
                        if (!error && data) {
                            setProfile(data);
                        }
                    } else {
...
_s(AuthInitializer, "rQUrTIjFnOBJZXaOIsLRY0q+zow=", false, function() {
    return [
...
const Navbar = ()=>{
    ...
    const { user, profile, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
...
_s(Navbar, "+avHBWx4f0QnoOzVcBjITywUrHo=", false, function() {
    return [
...
//# sourceMappingURL=src_0tvekpz._.js.map